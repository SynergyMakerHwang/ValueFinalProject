...
public class Washers : MonoBehaviour
{
    ...
    Vector3 EndPos1position = new Vector3(-15.879f, 9.2f, -0.5f);
    Vector3 EndPos2position = new Vector3(-16.5f, 9.2f, -0.5f);
    Vector3 EndPos3position = new Vector3(-20.4f, 9.2f, -0.5f);
